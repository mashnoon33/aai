...
export function useActionsMenu() {
  ...
  const handleMenuClick = (event: React.MouseEvent<HTMLElement>, row: TrialRow) => {
...
export const createColumns = (menuHandlers: ReturnType<typeof useActionsMenu>): GridColDef[] => {
  const { anchorEl, selectedRow, handleMenuClick, handleMenuClose, handleCopyNCT } = menuHandlers;
